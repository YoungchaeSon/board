...
//		return template.queryForObject(query, ParameterizedBeanPropertyRowMapper.newInstance(BDto.class));
	...
	public void modify(final String bId, final String lId, final String bTitle, final String bContent,String bName) {
		// TODO Auto-generated method stub
		try {
			...
			if(lId.equals("admin")) {
				...
				String query = "update mvc_board set bTitle = ?, bContent = ? where bId = ? and bName=?";
	...
	public void delete(final String lId, final String bId) {
		// TODO Auto-generated method stub
		try {
			...
			if(lId.equals("admin")) {
				...
				String query = "delete from mvc_board where bName=? and bId = ?";
				this.template.update(query, new PreparedStatementSetter() {
